...
import com.zego.livedemo5.aiya.AiyaMenu;
...
public class PublishFragment extends AbsBaseFragment implements MainActivity.OnReInitSDKCallback {
    ...
    protected void initViews() {
        ...
        mAiyaMenu=new AiyaMenu(getContext());
        ...
        ArrayAdapter<String> filterAdapter = new ArrayAdapter<>(mParentActivity, R.layout.item_spinner, names);
...
//                }
                AiyaEffects.getInstance().setEffect("assets/modelsticker/"+mAiyaMenu.getMenuList().get(mSelectedFilter).path);
            }
